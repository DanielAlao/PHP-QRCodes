...
$rows = $db->arraybuilder()->paginate('user_accounts', $page, $select);
$total_pages = $db->totalPages;
?>

<!DOCTYPE html>
<html lang="en">
    <title>List users - Qrcode Generator</title>
    <head>
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                <!-- <li class="breadcrumb-item">
                  <a href="add_admin.php" class="btn btn-success"><i class="fa fa-plus"></i> Add new user</a>
                </li> -->
                <li class="breadcrumb-item">
                  <a href="admin_index.php" class="btn btn-success"><i class="nav-icon fas fa-tachometer-alt"></i> Statistics</a>
                </li>
                <li class="breadcrumb-item">
                  <a href="admin_qrcodes.php" class="btn btn-success"><i class="fa fa-qrcode"></i> Qrcodes</a>
                </li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
